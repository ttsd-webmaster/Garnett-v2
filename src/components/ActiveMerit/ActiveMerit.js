...
export default class ActiveMerit extends Component {
  ...
  render() {
    return (
      <List>
        <ListItem
          leftAvatar={<Avatar size={70} src={require('./images/angie_joung.jpg')} />}
        >
        ...
        <Divider inset={true} />
        <ListItem
          leftAvatar={<Avatar size={70} src={require('./images/dat_nguyen.jpg')} />}
        >
        ...
        <Divider inset={true} />
        <ListItem
          leftAvatar={<Avatar size={70} src={require('./images/erick_wilson.jpg')} />}
        >
        ...
        <Divider inset={true} />
        <ListItem
          leftAvatar={<Avatar size={70} src={require('./images/huy_tran.jpg')} />}
        >
        ...
        <Divider inset={true} />
        <ListItem
          leftAvatar={<Avatar size={70} src={require('./images/jerry_qing.jpg')} />}
        >
        ...
        <Divider inset={true} />
        <ListItem
          leftAvatar={<Avatar size={70} src={require('./images/justin_lee.jpg')} />}
        >
        ...
        <Divider inset={true} />
        <ListItem
          leftAvatar={<Avatar size={70} src={require('./images/kakeru_imanaka.jpg')} />}
        >
        ...
        <Divider inset={true} />
        <ListItem
          leftAvatar={<Avatar size={70} src={require('./images/soyoun_park.jpg')} />}
        >
        ...
        <Divider inset={true} />
        <ListItem
          leftAvatar={<Avatar size={70} src={require('./images/stacy_kim.jpg')} />}
        >
        ...
        <Divider inset={true} />
        <ListItem
          leftAvatar={<Avatar size={70} src={require('./images/sydney_huynh.jpg')} />}
        >
